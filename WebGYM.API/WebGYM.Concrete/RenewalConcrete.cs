...
namespace WebGYM.Concrete
{
    public class RenewalConcrete : IRenewal
    {
        ...
        public async Task<RenewalViewModel> GetMemberNo(string memberNo , int userid)
        {
        ...
        public async Task<bool> CheckRenewalPaymentExists(DateTime newdate , long memberId)
        {
