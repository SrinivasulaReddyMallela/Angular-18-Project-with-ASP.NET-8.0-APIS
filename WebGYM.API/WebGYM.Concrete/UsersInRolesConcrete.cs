...
namespace WebGYM.Concrete
{
    public class UsersInRolesConcrete : IUsersInRoles
    {
        ...
        public async Task<bool> AssignRole(UsersInRoles usersInRoles)
        {
        ...
        public async Task<bool> CheckRoleExists(UsersInRoles usersInRoles)
        {
        ...
        public async Task<bool> RemoveRole(UsersInRoles usersInRoles)
        {
        ...
        public async Task<List<AssignRolesViewModel>> GetAssignRoles()
        {
