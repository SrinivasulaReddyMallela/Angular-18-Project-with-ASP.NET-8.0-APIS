...
namespace WebGYM.Concrete
{
    public class MemberRegistrationConcrete : IMemberRegistration
    {
        ...
        public async Task<bool> CheckNameExits(string memberFName, string memberLName, string memberMName)
        {
        ...
        public async Task<long> CheckNameExitsforUpdate(string memberFName, string memberLName, string memberMName)
        {
        ...
        public async Task<bool> DeleteMember(long memberId)
        {
            using (SqlConnection con = new SqlConnection(_configuration.GetConnectionString("DatabaseConnection")))
            {
                ...
                int result = con.Execute("picd_MemberRegistrationDeleteSingleItem", para, null, 0, CommandType.StoredProcedure);
                if (result > 0)
                {
                    return true;
                }
        ...
        public async Task <MemberRegistrationViewModel> GetMemberbyId(int memberId)
        {
            using (SqlConnection con = new SqlConnection(_configuration.GetConnectionString("DatabaseConnection")))
            {
                var para = new DynamicParameters();
                ...
                return (await con.QueryAsync<MemberRegistrationViewModel>("PICG_MemberRegistrationSelectSingleItem", para, null, 0, commandType: CommandType.StoredProcedure)).Single();
            }
        }


        public async Task<List<MemberRegistrationGridModel>> GetMemberList()
        {
            using (SqlConnection con = new SqlConnection(_configuration.GetConnectionString("DatabaseConnection")))
            {
                return (await con.QueryAsync<MemberRegistrationGridModel>("USP_MemberRegistrationSelectList", null,null,0, commandType: CommandType.StoredProcedure)).ToList();
            }
        }



        public async Task<int> InsertMember(MemberRegistration memberRegistration)
        {
            using (var con = new SqlConnection(_configuration.GetConnectionString("DatabaseConnection")))
            {
                ...
                int resultMember = con.Execute("USP_SAVE_MemberRegistrationInsertUpdateSingleItem", para, sqlTransaction, 0, CommandType.StoredProcedure);
                ...
                int resultPayment = con.Execute("USP_SAVE_PaymentDetailsInsertUpdateSingleItem", paramater, sqlTransaction, 0, CommandType.StoredProcedure);
        ...
        public async Task<int> UpdateMember(MemberRegistration memberRegistration)
        {
            using (var con = new SqlConnection(_configuration.GetConnectionString("DatabaseConnection")))
            {
                con.Open();
        ...
        public async Task<IQueryable<MemberRegistrationGridModel>> GetAll(QueryParameters queryParameters , int userId)
        {
        ...
        public async Task<List<MemberResponse>> GetMemberNoList(string membername, int userId)
        {
