...
export class LoginComponent implements OnInit
{
    ...
    constructor(private _Route: Router,public snackBar: MatSnackBar, loginservice: LoginService,private renderer:Renderer2) 
    {
        this._loginservice = loginservice;
        //this.renderer.setStyle(document.body, 'background', 'url("../../assets/Images/Gym-image.jpg")');
